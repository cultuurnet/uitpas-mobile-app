    ...
    <Container {...props}>
      <>
        ...
        <Styled.TextContainer isTile={isTile}>
          <SkeletonLoader layout={[{ height: 16, width: isTile ? 160 : 230 }]} />
          <SkeletonLoader layout={[{ height: 16, width: isTile ? 170 : 100 }]} />
          <SkeletonLoader layout={[{ height: 14, marginBottom: isTile ? 20 : 0, marginTop: 4, width: isTile ? 100 : 160 }]} />
