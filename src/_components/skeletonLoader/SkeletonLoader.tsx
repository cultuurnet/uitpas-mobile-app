...
import SkeletonContent, { ISkeletonProps } from 'react-native-reanimated-skeleton';

import { theme } from '../../_styles/theme';

type TSkeletonProps = { containerStyle?: StyleProp<ViewStyle>; dark?: boolean; layout: ISkeletonProps['layout'] };
